  ...
  <div>
    <el-dialog
      ...
      <el-form v-model="selectedUser" style="text-align: left" ref="dataForm">
        ...
        <el-form-item label=用户角色 label-width="120px" prop="name">
        ...
        <el-form-item label="角色分配" label-width="120px" prop="roles">
          <el-checkbox-group v-model="selectedRolesIds">
            <el-checkbox v-for="(role,i) in roles" :key="i" :label="role.id">{{role.roleDesc}}</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    deleteUser (user) {
      this.$axios.delete('/admin/user?uid=' + user.id).then(resp => {
        if (resp && resp.data.code === 200) {
